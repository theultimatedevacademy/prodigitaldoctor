    ...
    <div className="space-y-3">
      ...
      <div className="grid grid-cols-2 gap-4">
        ...
        >
          ...
          <span className="font-semibold text-lg">First Visit</span>
          <span className="text-sm text-gray-500 mt-1">New patient registration</span>
          {selectedType === 'first_visit' && (
        ...
        >
          ...
          <span className="font-semibold text-lg">Follow Up</span>
          <span className="text-sm text-gray-500 mt-1">Existing patient</span>
          {selectedType === 'follow_up' && (
            <div className="absolute top-2 right-2">
              <div className="w-6 h-6 bg-blue-500 rounded-full flex items-center justify-center">
                <svg className="w-4 h-4 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
