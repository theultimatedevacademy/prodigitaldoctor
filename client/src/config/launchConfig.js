...
export const launchConfig = {
  ...
  waitlist: {
    ...
    current: parseInt(import.meta.env.VITE_WAITLIST_CURRENT) || 0,
  ...
  features: {
    ...
    showFeatureComparison: import.meta.env.VITE_SHOW_FEATURE_COMPARISON === 'true',
    showTestimonials: import.meta.env.VITE_SHOW_TESTIMONIALS === 'true',
  },
  
  // CTA Configuration
  cta: {
    primaryText: import.meta.env.VITE_LAUNCH_MODE === 'launched'
      ? import.meta.env.VITE_CTA_TEXT_LAUNCHED || 'Start Free Trial'
      : import.meta.env.VITE_CTA_TEXT_PRELAUNCH || 'Join Waitlist',
    primaryAction: import.meta.env.VITE_LAUNCH_MODE === 'launched'
      ? '/sign-up'
      : '#waitlist',
  },
  ...
  // Early adopter offer
  earlyAdopter: {
    discount: parseInt(import.meta.env.VITE_EARLY_DISCOUNT) || 50,
